...
Debian unstable, and the I<bookworm-bpo> branch be where you prepare
your uploads to the B<bookworm-backports> suite.
...
B<bookworm-backports>, you do something like this:
...
of the I<bookworm-bpo> branch each time a new version migrates to Debian
...
entries for each previous upload to B<bookworm-backports>; in a rebasing
...
for a new backport of package 'foo' to B<bookworm-backports>, and then
...
B<bookworm-backports> you wish to overwrite.
...
I<--trust-changelog=1.2.2-1~bpo10+1>.
